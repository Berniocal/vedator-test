  ...
  view.innerHTML=`
    <div class="vedator-data-card">
      ...
      <div class="vedator-data-actions">
        <button class="vedator-data-button primary vedator-data-export" type="button">Zde je možné si vybrat zálohu.</button>
        <button class="vedator-data-button vedator-data-import" type="button">Čtení zálohy</button>
      </div>
