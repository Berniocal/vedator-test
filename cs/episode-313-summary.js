(()=>{
  ...
  const QUESTIONS=[
    ...
    {time:'9:02',title:'Co je to za záblesk?',points:['Běžný blesk vzniká přeskokem elektrického náboje.','Kulový blesk bývá popisován jako samostatná plazmová koule, ale jeho existence nebyla spolehlivě prokázána.','Krátké světelné jevy po úderu blesku mohou pozorovateli připomínat kulové vzplanutí.']},
    ...
    {time:'24:08',title:'Co právě čtou?',points:['Doporučují knihy Odvážnost být nepopulární, Kolečko času, Za horizontem událostí a Detektivka Červenaka.','Zmiňují také audioknihy.','Baví je sci-fi a fantasy zasazené do známých reálií.']}
  ];
